...
import MostViewedPropertiesComponent from "./MostViewedPropertiesComponent";
import { useNavigate } from "react-router-dom";
import { injectIntl } from 'react-intl';
import { Context } from "../../Wrapper";

const BuyPropertyComponent = (props) => {
  ...
  return (
    ...
    <div>
      <section className="bg-img-1 searchBanner cust-height">
        <div className="container-fluid">
          <h2 className="text-center text-white"> {formatMessage({ id: "buy.title" })}</h2>
          <h3 className="text-center text-white">{formatMessage({ id: "buy.description" })}</h3>
          <div className="row">
...
export default injectIntl(BuyPropertyComponent);